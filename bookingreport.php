...
session_start();
 if(isset($_SESSION['clientid']))
 {
     ...
     $bookingid=mysqli_real_escape_string($conn,$_GET['bid']);
     $sid=$_SESSION['clientid'];
           $sql="select * from payment where client_id='$sid' and bookingid='$bookingid'";
...
<div class="container-fluid paymentsuccess">
 <div class="row">
   <div class="col-12 text-center">
     <h2>Booking Receipt (Detail Description Of Your Booking !!)</h2>
</div>
