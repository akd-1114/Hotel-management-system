...
<div class="container-fluid user_report">
   <div class="row">
    <div class="col-12 one">
        <h2 class="text-center">System User Report</h2>
    </div>
    <div class="col-12">
   <table class="table ">
       <thead>
       ...
       <tbody>
         <?php  while($rows=mysqli_fetch_assoc($result)) {?>
           <tr class="text-center">
               ...
               <td><button type="button" name="submit" class="btn btn-success">Edit</button> | <button type="button" name="submit" class="btn btn-danger">Delete</button></td>
           </tr>
         <?php }?>
       </tbody>
</table>
