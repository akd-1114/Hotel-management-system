    ...
    <li class="breadcrumb-item active" aria-current="page">Suite Room</li>
      ...
      <div class="booking-item-detail">
         <header class="booking-item-header">
			<div class="row">
					<div class="col-md-8">
						<h2 class="lh1em" style="font-size:2.2em">Hotel Samrat, Patna -Suite Room</h2>
					</div>
					<div class="col-md-4">
			...
			<div class="row">
                ...
                <div class="tab-content">
								<div class="fotorama" data-nav="thumbs" data-allowfullscreen="true" data-loop="true">
									<img src="images/room5.jpg" alt="Standard Non A/C Room" title="Standard Non A/C Room" class="img-fluid rounded d-block mx-auto clearfix"/>
									<img src="images/bed-bedroom-cozy-164595.jpg" alt="Standard Non A/C Room" title="Standard Non A/C Room" class="img-fluid rounded d-block mx-auto clearfix"/>
			...
			<div class="row">
				    ...
				    <div class="col-md-4">
                                <a href="deluxe-room.php">
									<img src="images/room9.jpg" alt="Hotel Samrat-Deluxe-Room" class="img-fluid rounded d-block mx-auto clearfix" />
								</a>
								<h4 class="text-center one" ><a href="deluxe-room.php">Delux Room</a></h4>
					</div>
					<div class="col-md-4">
                                <a href="standard-non-ac-room.php">
									<img src="images/room10.jpg" alt="Hotel Samrat-Standard Non A/C Room" class="img-fluid rounded d-block mx-auto clearfix" />
								</a>
